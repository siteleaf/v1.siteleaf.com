---
title: User roles
date: 2014-05-12 14:33:00 Z
---

User roles allow you to set the level of control each collaborator has over your site content. You can now set a collaborator’s role to one of the following:
