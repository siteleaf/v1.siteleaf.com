...
assets:
- path: "/uploads/porting-a-theme-to-siteleaf-martin.png"
- path: "/uploads/porting-a-theme-to-siteleaf-header.png"
- path: "/uploads/porting-a-theme-to-siteleaf-sections.png"
tags:
- tutorial
- liquid
Docs:
