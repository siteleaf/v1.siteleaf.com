...
assets:
- path: "/uploads/an-introduction-to-siteleaf-collaboration.png"
- path: "/uploads/an-introduction-to-siteleaf-anvil.jpg"
- path: "/uploads/an-introduction-to-siteleaf-publish.png"
- path: "/uploads/an-introduction-to-siteleaf-interface.png"
tags:
- tutorial
- liquid
Docs:
